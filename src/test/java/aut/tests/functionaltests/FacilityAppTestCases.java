	...
	public void QA039_FrequencyFieldSelection_WithFrequencyType_Routine()
	{
...

		{
			...
			for(int newnum=2;newnum<=21;newnum ++)
			{
				...
				String[] FrequencyNames = {testdata.get("frequency1"),testdata.get("frequency2"),testdata.get("frequency3"),testdata.get("frequency4"),testdata.get("frequency5"),testdata.get("frequency6"),testdata.get("frequency8"),testdata.get("frequency9"),testdata.get("frequency10"),
